...
const FilterSideBar = () => {
// to read and modify the query parameter
const [searchParams, setSearchParams] = useSearchParams();
const navigate = useNavigate();
//x.com/?a=1&b=2
// storing all values of filter
...
// let's create a constant to convert these search params into plane object
useEffect(()=>{
...
navigate(`?${params.toString()}`); //?category=bpttom+wear
}
    ...
    <div className="p-4">
      ...
      <div className="mb-6">
        ...
        <div className="flex flex-wrap gap-2">
          {colors.map((color)=>(
            <button key={color} name="color" className={`w-8 h-8 rounded-full border broder-gray-300 cursor-pointer transition hover:scale-105filters.color === color ? "ring-2 ring-blue-500":""`} style = {{backgroundColor : color.toLowerCase()}}
            value={color}
