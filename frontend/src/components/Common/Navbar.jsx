        ...
        <>
            <nav className='container mx-auto flex items-center justify-between py-4 px-6'>
                ...
                <div className="hidden md:flex space-x-6">
                    ...
                    <Link to="/collections/all?category=Top Wear" className='text-gray-700 hover:text-black text-sm font-medium uppercase'>T
                    op Wear</Link>
...
<Link to="/admin" className='block bg-black px-2 py-1 rounded text-md text-white'>Admin</Link>
                    )}
            ...
            {/* Mobile Navigaation */}
            <div className={`fixed top-0 left-0 w-3/4 sm:w-1/2 md:w-1/3 h-full bg-white shadow transform transition duration-300 z-50 ${navDrawerOpen ? "translate-x-0" : "-translate-x-full"}`}>
