...
navigate('/login?redirect=checkout');
   ...
   return (
     <div className={`fixed top-0 right-0 -3/4 sm:w-1/2 md:w-[35rem] h-full bg-white shadow-lg transform transition-transform duration-300 flex flex-col z-50 ${drawerOpen ? "translate-x-0" :"translate-x-full"}`}>
{/* close button */}
 ...
 */}
 <div className='p-4 bg-white sticky bottom-4'>
